...
parse_base.add_argument("password", type=str, required=True, help='请提供密码')
parse_base.add_argument("action", type=str, required=True, help='请确认动作')

parse_register = parse_base.copy()

parse_register.add_argument("username", type=str, required=True, help='请提供用户名')
parse_register.add_argument("phone", type=str, required=True, help='请提供手机号')

parse_login = parse_base.copy()
parse_login.add_argument("username", type=str, help='请提供用户名')
parse_login.add_argument("phone", type=str, help='请提供手机号')
    ...
    def post(self):
        ...
        if action == USER_ACTION_REGISTER:
            ...
            if not movie_user.save():
                abort(400, msg="create not success")
