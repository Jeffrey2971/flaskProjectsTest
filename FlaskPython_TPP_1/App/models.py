...
"""
{
      ...
      "showName": "八佰",
      "director": "管虎",
      "leadingRole": "姜武,张译,王千源,黄志忠,张俊一,欧豪,胡晓光,张承",
      "type": "剧情,战争,历史",
      "country": "中国大陆",
      "language": "汉语普通话",
      "duration": 160,
      "openDay": "2020-12-31 00:00:00",
      "poster": "i2/TB1Mf87eRCw3KVjSZFuXXcAOpXa_.jpg",
      "orderCount": 0
"""
...
class Movie(db.Model):
    ...
    director = db.Column(db.String(16))
...
("深圳戏城影院", "深圳", "罗湖", "罗湖区新园路1号东门步行街西口", "0755-82175808", 9.7,9,1.2,20,1,0)
"""
...
class User(BaseModel, db.Model):
    ...
    u_password = db.Column(db.String(256))  # 256是为了做数据安全
